...
<section class="hero card">
  ...
  <p class="lead">Analyze and visualize Greek morphological data.</p>
</section>
...
<div class="card">
  ...
  <div class="btn-row">
    <button id="btnLoadBundled" class="btn">Load bundled default CSV (assets/data/default.csv)</button>
  </div>
...
<div class="card">
  <ol>
    <li>Place your default file at <code>assets/data/default.csv</code> inside this repo.</li>
    ...
    <li>Use <strong>Load bundled default CSV</strong> at startup to load it instantly.</li>
  </ol>
  <div class="help">If you want a different filename/path, edit <code>DEFAULT_BUNDLED_CSV_URL</code> in <code>assets/js/app.js</code>.</div>
</div>
